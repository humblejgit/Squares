...
public final class ComputerStrategy {
    ...
    public static GameMove chooseMove(int rows, int columns, int[][] horizontalEdges, int[][] verticalEdges,
    ...
    public static Decision chooseDecision(int rows, int columns, int[][] horizontalEdges, int[][] verticalEdges,
        ...
        return new Decision(new GameMove(move.horizontal, move.rowOrLine, move.columnOrLine),
                thinkingDelayMillis(board, moveIndex, skill, random));
    }
    ...
    public static final class Decision {
        ...
        private Decision(GameMove move, int thinkingDelayMillis) {
            this.move = move;
