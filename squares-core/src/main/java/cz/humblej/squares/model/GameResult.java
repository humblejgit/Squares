...
public final class GameResult {
    ...
    public GameResult(UUID gameId, Instant startedAt, Instant finishedAt, Mode mode,
    ...
    public boolean randomInitialEdges() {
    ...
    public PlayerResult redPlayer() {
        return redPlayer;
    }

    public PlayerResult bluePlayer() {
        return bluePlayer;
    }
