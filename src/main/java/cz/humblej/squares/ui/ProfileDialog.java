...
public final class ProfileDialog {
    ...
    public static PlayerProfile chooseActive(JFrame parent, ProfileStore store) {
        while (true) {
            try {
    ...
    public static PlayerProfile chooseOpponent(JFrame parent, ProfileStore store, PlayerProfile activeProfile) {
        try {
