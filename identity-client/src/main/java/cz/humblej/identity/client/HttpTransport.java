...
public final class HttpTransport {
    ...
    public Response postForm(URI uri, String form) throws IOException {
        HttpURLConnection connection = open(uri, "POST");
        connection.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");
        return execute(connection, form.getBytes(StandardCharsets.UTF_8));
    }

    public Response putJson(URI uri, String json, String bearerToken) throws IOException {
        return putJson(uri, json, bearerToken, Collections.<String, String>emptyMap());
    }

    public Response putJson(URI uri, String json, String bearerToken,
